        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative group">
              ...
              <img 
                ...
                alt="סתיו אוליאל - מעצבת גבות ומאפרת מקצועית"
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-primary leading-tight mb-8">
              סתיו אוליאל <br /> 
              <span className="text-accent underline decoration-accent/30 decoration-4 underline-offset-8 decoration-wavy">מעצבת גבות ומאפרת מקצועית</span>
            </h2>
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              ...
              <p>
                [טקסט דמה המציג בקצרה את האני-מאמין המקצועי ואת חוויית הטיפול בסטודיו. בגרסה הסופית יופיע כאן טקסט שיווקי ממוקד.]
              </p>
              <p>
