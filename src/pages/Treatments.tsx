...
const allTreatments = [
  {
    category: "שם קטגוריה",
    items: [
      { name: "שם שירות", price: "₪₪₪", desc: "[טקסט דמה המתאר את השירות ותוצאותיו המצופות. הפירוט המלא יוצג בגרסה הסופית של האתר.]" },
      { name: "שם שירות", price: "₪₪₪", desc: "[טקסט דמה המתאר את השירות ותוצאותיו המצופות. הפירוט המלא יוצג בגרסה הסופית של האתר.]" },
      { name: "שם שירות", price: "₪₪₪", desc: "[טקסט דמה המתאר את השירות ותוצאותיו המצופות. הפירוט המלא יוצג בגרסה הסופית של האתר.]" }
    ]
  },
  ...
  return (
    <div className="bg-background min-h-screen py-16 pt-32">
      <div className="container px-4 mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-primary">תפריט שירותים</h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            בחרי את השירות המתאים לך. כל השירותים מתבצעים באמצעות המכשירים והחומרים האיכותיים ביותר.
          </p>
        </motion.header>
                    ...
                    <Card className="h-full border-none shadow-sm hover:shadow-xl transition-all duration-300 bg-surface group">
                      ...
                      <CardContent>
                        ...
                        <Button variant="link" className="p-0 h-auto mt-6 text-primary font-bold group-hover:translate-x-[-4px] transition-transform" asChild>
                          <a href={`https://wa.me/9725XXXXXXXX?text=היי סתיו, אשמח לקבוע תור ל${treatment.name}`}>
                            קבעי תור עכשיו ←
                          </a>
                        </Button>
                      </CardContent>
        ...
        >
          ...
          <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto leading-relaxed">
            אני כאן כדי לעזור לך לבחור את השירות המדויק עבורך. צרי איתי קשר לייעוץ ראשוני ללא התחייבות.
          </p>
