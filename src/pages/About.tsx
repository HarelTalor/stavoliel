...
const clinicImages = [
  { src: "/images/clinic_interior.png", alt: "חלל הסטודיו" },
  { src: "/images/clinic_interior_v2.png", alt: "אזור השירותים" },
    ...
    <div className="bg-background min-h-screen pt-32 pb-16">
      <div className="container px-4 mx-auto">
        ...
        <ScrollReveal>
          ...
          >
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-primary">אודות סתיו אוליאל</h1>
            ...
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto pt-4 leading-relaxed">
              הסיפור מאחורי הסטודיו, הגישה המקצועית והמחויבות למצוינות בכל פרט.
            </p>
          </motion.div>
        </ScrollReveal>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                <p className="font-bold">
                  [טקסט דמה המציג את המשפט הפותח של האודות והחזון המקצועי של הסטודיו.]
                </p>
                <p>
                  [טקסט דמה המתאר את הניסיון המקצועי, ההכשרות והערך המוסף של טיפולי הסטודיו עבור הלקוחה. כאן יופיע סיפור המותג המורחב.]
                </p>
                <p>
        ...
        <div className="mb-32">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-3xl font-serif font-bold text-primary">סיור בסטודיו</h2>
            </div>
          </ScrollReveal>
